...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        // Use auto row height so rows grow to content and avoid overlap
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // light styles
      "bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:bg-neutral-950",
      // dark styles
      "transform-gpu dark:bg-white dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] dark:dark:bg-neutral-950",
      className,
    )}
    {...props}
  >
